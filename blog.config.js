...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到狼友收藏夹',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '上车方式：如您不知道我们的上车暗号，请点击页面右下角<消息按钮>打开聊天框，发送“获取暗号”，我们会在2分钟内回复您', // 作者简介
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '其实你想看的，网上都有', // 站点描述，被notion中的页面描述覆盖
